...
import { HEADER_CATEGORIES, HEADER_TAB } from './header.constant'
import './header.scss'
...
const HeaderTab = () => {
  ...
  return HEADER_TAB.map(item => (
    <h4 style={activeColor(item.active)}>{item.name}</h4>
  ))
}
  ...
  return (
    <>
      <div id="navbar">
        ...
        <HeaderTab />
        <a href="./login.html">
          <h4 id="userid">Sign In</h4>
        </a>
        <a href="./signup_card.html">
          <button id="signup">Join</button>
        </a>
      </div>
      <div class="dropdown">
        <HeaderCategory categories={HEADER_CATEGORIES} />
        {/* <ul>
          <li class="gd">
            Graphics & Design
            <div id="ele1">
